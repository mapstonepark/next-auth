...
<header className="p-4 bg-gray-100 text-gray-800">
	<div className="container flex justify-between h-16 mx-auto">
		<a rel="noopener noreferrer" href="#" aria-label="Back to homepage" className="flex items-center p-2">
			<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32" className="w-8 h-8 text-amber-600">
		...
		<div className="items-center flex-shrink-0 hidden lg:flex">
			...
			<button className="self-center px-8 py-3 font-semibold rounded bg-amber-600 text-gray-50"><Link href='/dashboard'>Sign up</Link> </button>
		</div>
